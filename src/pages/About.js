    ...
    return (
        <div>
          ...
          <Navigation/>
            ...
            <br />
            <p>
              Welcome to my portfolio! I am a passionate front-end developer, always eager to learn and grow in the ever-evolving world of web development. With a strong foundation in JavaScript, React, Node.js, and other cutting-edge technologies, I aim to create dynamic and responsive web applications that provide seamless user experiences. My journey in development started several years ago when I discovered the power of coding and its potential to solve real-world problems.
